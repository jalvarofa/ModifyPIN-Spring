package com.companyname.springapp.account;
...
//     */
//    public boolean deleteTitular(String id) {
//        boolean found = false;
//        int i = 0;
//        while (i < this.titulars.size() && !found) {
...
//     * @return ( true if success, else false )
//     */
//    public boolean deleteAuthorized(String id) {
//        boolean found = false;
//        int i = 0;
//        while (i < this.authorizeds.size() && !found) {
...
//     * @return
//     */
//    public boolean deleteLiquidationStrategy(String id) {
//        int i = 0;
//        boolean found = false;
//        while (i < this.liquidationStrategies.size() && !found) {
